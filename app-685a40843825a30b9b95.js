...
function sendWebVitals() {
  ...
  return __webpack_require__.e(/* import() */ 574).then(__webpack_require__.bind(__webpack_require__, 1574)).then(({
    getLCP,
    getFID,
    getCLS
  }) => {
...
function onInitialClientRender(_, pluginOptions) {
  if ( true && typeof ga === `function` && pluginOptions.enableWebVitalsTracking) {
    sendWebVitals();
  }
}
...
var _templateObject;const N=c=>{const{size:u}=i(c);return/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(B,{size:u,children:(0,toConsumableArray/* default */.A)(Array(12)).map((Z,b)=>/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(Spinner_i,{index:b},"spinner-stick-"+b))});},y=(0,emotion_react_browser_esm/* keyframes */.i7)(_templateObject||(_templateObject=(0,taggedTemplateLiteralLoose/* default */.A)(["\n  from {\n    opacity: 1;\n  }\n  to {\n    opacity: 0.15;\n  }\n"]))),B=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e1fxu76s1"}:0)("position:relative;display:flex;justify-content:center;align-items:center;",c=>/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("width:",c.size+"px",";height:",c.size+"px",";"+( true?"":0), true?"":0, true?"":0, true?"":0),";"+( true?"":0)),Spinner_i=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e1fxu76s0"}:0)("animation:",y," 1.2s linear infinite;position:absolute;width:24%;height:8%;border-radius:5px;background:",type/* Colors */.Jy.PRIMARY.ACCENT_7,";",c=>/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("animation-delay:",-1.2+c.index*0.1,"s;transform:rotate(",30*c.index,"deg) translate(146%);"+( true?"":0), true?"":0, true?"":0, true?"":0),";"+( true?"":0));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Ex: function() { return /* reexport */ Badge_d; },
  ...
  mc: function() { return /* reexport */ Container_X; },
  ...
  DP: function() { return /* reexport */ F; },
  Yf: function() { return /* reexport */ ToastRoot_L; },
...
__webpack_require__.d(parts_namespaceObject, {
  rc: function() { return Action_N; },
  En: function() { return Actions_d; },
  nB: function() { return Body_r; },
  Y9: function() { return Header_t; },
  aF: function() { return Modal_L; },
  hE: function() { return Title_u; }
});
...
function Toast_X(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Toast_a=5e3,Toast_r=I=>{const{order:g,hover:C,text:n,type:N,remove:y}=I,c=(0,react.useRef)(null),[R,t]=(0,react.useState)({}),[J,H]=(0,react.useState)(!1);return useMount_f(()=>{const b=()=>{y();},Z=setTimeout(()=>{var l;H(!0),(l=c.current)==null||l.addEventListener("transitionend",b);},Toast_a);return()=>{clearTimeout(Z),c.current&&c.current.removeEventListener("transitionend",b);};}),(0,react.useEffect)(()=>{var _ref,_ref2;var i,W,B;const b=(W=(i=c.current)==null?void 0:i.parentElement)==null?void 0:W.children,Z=((_ref=b==null?void 0:b.length)!==null&&_ref!==void 0?_ref:0)-1-g;let l=50;l=Array.from(b!==null&&b!==void 0?b:[]).filter((G,A)=>Z<A).reduce((G,A)=>(G+=Math.floor(A.getBoundingClientRect().height)+20,G),0);const v=(_ref2=(B=c.current)==null?void 0:B.getBoundingClientRect().height)!==null&&_ref2!==void 0?_ref2:"50";let u=g===0?"none":"translate3d(0, calc("+v+"px + -100% + "+-20*g+"px), -"+g+"px) scale("+(1-g*0.05)+")";C&&g!==0&&(u="translate3d(0, -"+l+"px, -"+g+"px) scale(1)"),t({opacity:"1",transform:u});},[g,C]),/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(Toast_h,{ref:c,style:R,type:N,destroy:J,children:/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(Toast_p,{children:/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(L,{children:n})})});},x=I=>({primary:I.colors.PRIMARY.BACKGROUND,success:I.colors.SUCCESS.DEFAULT,error:I.colors.ERROR.DEFAULT});var z= true?{name:"728dx5",styles:"opacity:0!important"}:0;const Toast_h=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e10rafsz2"}:0)("position:absolute;bottom:0;right:0;border-radius:5px;padding:24px;transition:all 0.4s ease;box-sizing:border-box;opacity:0;transform:translate3d(0, 100%, 150px) scale(1);",_ref3=>{let{theme:I,type:g,destroy:C}=_ref3;return/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("box-shadow:",I.shadows.SMALL,";background:",x(I)[g],";color:",g==="primary"?I.colors.PRIMARY.FOREGROUND:"#fff",";z-index:",I.layers.SNACKBAR,";",C&&z,";"+( true?"":0), true?"":0, true?"":0, true?"":0);},"@media (max-width: 440px){width:90vw;}"+( true?"":0)),Toast_p=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e10rafsz1"}:0)( true?{name:"6l8n9h",styles:"max-width:100%;width:420px;display:flex;align-items:center;justify-content:space-between;font-size:0.875rem"}:0),L=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e10rafsz0"}:0)( true?{name:"jgybn3",styles:"margin-top:-1px;width:100%;height:100%;word-break:break-word"}:0);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js + 5 modules
var toConsumableArray = __webpack_require__(251);
...
const[ToastRoot_a,ToastRoot_e]=(0,createContext/* createContext */.q)();function ToastRoot_L(){const{state:g}=ToastRoot_e();return{message:g.message,success:g.success,error:g.error};}let ToastRoot_i=0;const ToastRoot_r=_ref=>{let{children:g}=_ref;const[G,u]=(0,react.useState)({toastList:[]});return/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsxs */.FD)(ToastRoot_a,{state:{toastList:G.toastList,message:X,success:c,error:l,remove:V},children:[g,/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(N,{})]});function X(I){C(I,"primary");}function c(I){C(I,"success");}function l(I){C(I,"error");}function C(I,b){u(typeof I=="string"?d=>Object.assign({},d,{toastList:[].concat((0,toConsumableArray/* default */.A)(d.toastList),[{text:I,toastUniqueCount:ToastRoot_i++,type:b}])}):d=>Object.assign({},d,{toastList:[].concat((0,toConsumableArray/* default */.A)(d.toastList),[Object.assign({},I,{toastUniqueCount:ToastRoot_i++,type:b})])}));}function V(I){u(b=>Object.assign({},b,{toastList:b.toastList.filter(d=>d.toastUniqueCount!==I)}));}},N=()=>{const{state:g}=ToastRoot_e(),G=(0,react.useRef)(null),[u,X]=(0,react.useState)(!1);return (0,react.useEffect)(()=>{var C,V;const c=()=>{X(!0);},l=()=>{X(!1);};return(C=G.current)==null||C.addEventListener("mouseenter",c),(V=G.current)==null||V.addEventListener("mouseleave",l),()=>{var I,b;(I=G.current)==null||I.removeEventListener("mouseenter",c),(b=G.current)==null||b.removeEventListener("mouseleave",l);};},[]),(0,react.useEffect)(()=>{g.toastList.length===0&&X(!1);},[g.toastList]),typeof document>"u"?/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(emotion_react_jsx_runtime_browser_esm/* Fragment */.FK,{}):/*#__PURE__*/react_dom.createPortal(/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(H,{ref:G,children:g.toastList.map((c,l,C)=>/* @__PURE__ */(0,emotion_react_browser_esm/* createElement */.n)(Toast_r,Object.assign({hover:u},c,{order:C.length-1-l,key:c.toastUniqueCount,remove:()=>g.remove(c.toastUniqueCount)})))}),document.body);},H=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e1zusuu0"}:0)("position:fixed;right:1.5rem;bottom:1.5rem;max-width:420px;transition:all 0.4s ease;",_ref2=>{let{theme:g}=_ref2;return/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("z-index:",g.layers.SNACKBAR,";"+( true?"":0), true?"":0, true?"":0, true?"":0);},"@media (max-width: 440px){max-width:90vw;right:5vw;}&>div:not(:first-of-type)::after{content:'';position:absolute;left:0;right:0;top:calc(100% + 1px);width:100%;height:20px;background:transparent;}&>div:nth-last-of-type(n + 4){opacity:0!important;pointer-events:none;}&:hover{transform:translate3d(0, -10px, 0);}"+( true?"":0));
// EXTERNAL MODULE: ../../packages/design-system/dist/components/ThemeProvider/type.js
var type = __webpack_require__(1091);
;// ../../packages/design-system/dist/components/ThemeProvider/ThemeProvider.js
function ThemeProvider_d(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const ThemeProvider_u={LIGHT:{colors:type/* Colors */.Jy,layers:type/* Layers */.zg,shadows:(0,type/* Shadows */.qd)()},DARK:{colors:Object.assign({},type/* Colors */.Jy,{PRIMARY:{ACCENT_1:type/* Colors */.Jy.PRIMARY.ACCENT_8,ACCENT_2:type/* Colors */.Jy.PRIMARY.ACCENT_7,ACCENT_3:type/* Colors */.Jy.PRIMARY.ACCENT_6,ACCENT_4:type/* Colors */.Jy.PRIMARY.ACCENT_5,ACCENT_5:type/* Colors */.Jy.PRIMARY.ACCENT_4,ACCENT_6:type/* Colors */.Jy.PRIMARY.ACCENT_3,ACCENT_7:type/* Colors */.Jy.PRIMARY.ACCENT_2,ACCENT_8:type/* Colors */.Jy.PRIMARY.ACCENT_1,BACKGROUND:type/* Colors */.Jy.PRIMARY.FOREGROUND,FOREGROUND:type/* Colors */.Jy.PRIMARY.BACKGROUND}}),layers:type/* Layers */.zg,shadows:(0,type/* Shadows */.qd)(!0)}},[ThemeProvider_Z,ThemeProvider_m]=(0,createContext/* createContext */.q)(),v=_ref=>{let{theme:b="LIGHT",children:t}=_ref;const[c,i]=(0,react.useState)(b);return/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsxs */.FD)(ThemeProvider_Z,{state:{changeTheme:l},children:[/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(ThemeProvider_x,{}),/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(emotion_element_f0de968e_browser_esm.a,{theme:ThemeProvider_u[c],children:/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(ToastRoot_r,{children:t})})]});function l(e){i(e);}},F=ThemeProvider_m;var ThemeProvider_h= true?{name:"hg6til",styles:"@import url('https://cdn.jsdelivr.net/gh/orioncactus/pretendard/dist/web/static/pretendard.css');{}:root{--font-family:'Pretendard',-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;--code-font-family:Menlo,'DM Mono','Roboto Mono',Courier New,monospace;--scrollbar-background:#1e1e1e;--scrollbar-thumb:#666;--scrollbar-thumb-highlight:#ff0080;}html{font-size:16px;height:100%;overflow-x:hidden;overflow-y:scroll;-webkit-overflow-scrolling:touch;scrollbar-width:8px;scrollbar-color:var(--scrollbar-thumb-highlight) var(--scrollbar-background);@media screen and (max-width: 1024px){font-size:14px;}&::-webkit-scrollbar{background:var(--scrollbar-background);height:8px;width:8px;}&::-webkit-scrollbar-thumb{background:var(--scrollbar-thumb-highlight);border-radius:0;}}html,body{font-family:var(--font-family)!important;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;font-size:1rem;}div,article,section{box-sizing:border-box;}html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:1rem;font:inherit;vertical-align:baseline;}label,input,button,a{-webkit-tap-highlight-color:transparent;}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block;}body{line-height:1;}ol,ul{list-style:none;}blockquote,q{quotes:none;}blockquote:before,blockquote:after,q:before,q:after{content:'';content:none;}table{border-collapse:collapse;border-spacing:0;}string{font-weight:600!important;}"}:0;const ThemeProvider_x=()=>/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(emotion_react_browser_esm/* Global */.mL,{styles:ThemeProvider_h});
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js
var objectWithoutPropertiesLoose = __webpack_require__(8910);
...
const _excluded=["as","children"];function Text_u(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Text_m=c=>{const _A=useText_r(c),{as:I,children:b}=_A,g=(0,objectWithoutPropertiesLoose/* default */.A)(_A,_excluded),C=Text_i.withComponent(I, true?{target:"e1dke28y1"}:0);return/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(C,Object.assign({},g,{children:b}));},Text_Z={10:0.625,12:0.75,14:0.875,16:1,20:1.25,24:1.5,32:2,40:2.5,48:3};"production";const Text_i=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("p", true?{target:"e1dke28y0"}:0)(_ref=>{let{size:c,lineHeight:I,color:b,weight:g,align:C,wrap:B}=_ref;return/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("color:",b||"inherit",";font-size:",Text_Z[c!==null&&c!==void 0?c:16],"rem;line-height:",I?I+"px":1.5,";",g&&/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("font-weight:",g,";"+( true?"":0), true?"":0, true?"":0, true?"":0),";"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0));
...
const Inset_g=c=>{const{children:b}=W(c);return/* @__PURE__ */I(Inset_Z,{children:b});},Inset_Z=/* @__PURE__ */(/* unused pure expression or super */ null && (l("div", true?{target:"edjs1210"}:0)("margin:0 -1.5rem;",_ref=>{let{theme:c}=_ref;return/*#__PURE__*//* @__PURE__ */G("border-top:1px solid ",c.colors.PRIMARY.ACCENT_2,";border-bottom:1px solid ",c.colors.PRIMARY.ACCENT_2,";background:1px solid ",c.colors.PRIMARY.ACCENT_1,";padding:1.5rem;"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0))));
...
function Container_l(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}var Container_i= true?{name:"sjczm1",styles:"justify-content:center;align-items:center"}:0;const Container_X=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e1h0g5no0"}:0)("display:flex;flex-direction:column;position:relative;min-width:1px;max-width:100%;justify-content:flex-start;align-items:stretch;flex-basis:auto;box-sizing:border-box;",_ref=>{let{row:C,flex:c=1,gap:g=1,center:A,wrap:b="wrap"}=_ref;return/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("flex:",c,";flex-wrap:",b,";",C?/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("flex-direction:row;&>*:not(:first-of-type){margin-left:calc(",g," * 1rem);}"+( true?"":0), true?"":0, true?"":0, true?"":0):/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("&>section,&>div,&>article,&>header,&>footer{gap:calc(",g," * 1rem);}&:last-of-type{margin-bottom:0;}"+( true?"":0), true?"":0, true?"":0, true?"":0)," ",A&&Container_i,";"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0));
...
const Spacer_i=I=>{const{x:g=1,y:c=1}=I;return/* @__PURE__ */(0,emotion_react_jsx_runtime_browser_esm/* jsx */.Y)(Spacer_G,{x:g,y:c});},Spacer_G=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("span", true?{target:"e1j7qga90"}:0)(_ref=>{let{x:I,y:g}=_ref;return/*#__PURE__*//* @__PURE__ */(0,emotion_react_browser_esm/* css */.AH)("margin-left:calc(",1.5*I,"rem - 1px);margin-top:calc(",1.5*g,"rem - 1px);"+( true?"":0), true?"":0, true?"":0, true?"":0);}," width:1px;height:1px;min-width:1px;min-height:1px;"+( true?"":0));
...
const Tag_excluded=(/* unused pure expression or super */ null && (["children","onRemove","id"]));function V(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Tag_x=g=>{const _X=X(g),{children:I,onRemove:c,id:G}=_X,C=_objectWithoutPropertiesLoose(_X,Tag_excluded);return/* @__PURE__ */Z(Tag_B,Object.assign({},C,{children:[/* @__PURE__ */b("div",{children:I}),C.hasRemove&&/* @__PURE__ */b(Tag_d,{onClick:()=>G?c==null?void 0:c(G):console.log("id가 지정되지 않았습니다."),children:/* @__PURE__ */b(u,{size:16})})]}));};var Tag_i= true?{name:"1j7gh9q",styles:"border-right:none;border-radius:5px 0 0 5px"}:0;const Tag_B=/* @__PURE__ */(/* unused pure expression or super */ null && (A("li", true?{target:"ewhr9121"}:0)(_ref=>{let{theme:g,hasRemove:I}=_ref;return/*#__PURE__*//* @__PURE__ */l("display:flex;margin-bottom:5px;margin-right:5px;margin-top:5px;overflow:hidden;text-overflow:ellipsis;color:",g.colors.PRIMARY.ACCENT_6,";box-sizing:inherit;white-space:nowrap;height:32px;&>div{background-color:",g.colors.PRIMARY.ACCENT_1,";border:1px solid ",g.colors.PRIMARY.ACCENT_2,";border-radius:5px;font-size:0.875rem;padding:0 6px;align-items:center;display:flex;overflow:hidden;text-overflow:ellipsis;",I&&Tag_i,";}"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0)))),Tag_d=/* @__PURE__ */(/* unused pure expression or super */ null && (A("button", true?{target:"ewhr9120"}:0)(_ref2=>{let{theme:g}=_ref2;return/*#__PURE__*//* @__PURE__ */l("background-color:",g.colors.PRIMARY.ACCENT_1,";border-radius:0 5px 5px 0;border:1px solid ",g.colors.PRIMARY.ACCENT_2,";color:",g.colors.PRIMARY.ACCENT_5,";cursor:pointer;display:flex;justify-content:center;align-items:center;margin:0;outline:0;padding:0 4px;transition:background-color 0.2s ease,border 0.2s ease,color 0.2s ease;&:hover{background-color:",g.colors.ERROR.DEFAULT,";border-color:",g.colors.ERROR.DEFAULT,";color:",g.colors.PRIMARY.BACKGROUND,";}"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0))));
;// ../../packages/design-system/dist/components/Tags/index.js
function Tags_l(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Tags_b=c=>{const{children:e}=c;return/* @__PURE__ */t(Tags_i,{children:e});},Tags_i=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("ul", true?{target:"e1juyxdg0"}:0)( true?{name:"u245qz",styles:"display:flex;align-items:center;flex-wrap:wrap;list-style:none;padding:0;margin:0"}:0);
...
function ShowMore_l(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const ShowMore_X=g=>{const{expanded:C,onClick:u}=g;return/* @__PURE__ */c(ShowMore_Z,{children:[/* @__PURE__ */I(ShowMore_G,{}),/* @__PURE__ */c(ShowMore_V,{onClick:u,children:[C?"SHOW LESS":"SHOW MORE",/* @__PURE__ */I(ShowMore_i,{expanded:C,viewBox:"0 0 24 24",width:"18",height:"18",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",fill:"none",shapeRendering:"geometricPrecision",children:/* @__PURE__ */I("path",{d:"M6 9l6 6 6-6"})})]}),/* @__PURE__ */I(ShowMore_G,{})]});},ShowMore_Z=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"ex8l8uj3"}:0)( true?{name:"twfy99",styles:"display:flex;width:calc(100% - 40px);margin-top:1.125rem;margin-left:1.125rem;box-align:center;align-items:center;min-height:30px;&,& *{gap:0!important;}"}:0),ShowMore_V=/* @__PURE__ */(/* unused pure expression or super */ null && (b("button", true?{target:"ex8l8uj2"}:0)(_ref=>{let{theme:g}=_ref;return/*#__PURE__*//* @__PURE__ */A("border:0;padding:5px 15px;border-radius:100px;box-shadow:",g.shadows.SMALL,";outline:0;cursor:pointer;font-size:12px;text-transform:uppercase;color ",g.colors.PRIMARY.ACCENT_5,";height:28px;background-color:",g.colors.PRIMARY.BACKGROUND,";transition:all 0.2s ease;display:inline-flex;align-items:center;max-width:100%;&:hover{color:",g.colors.PRIMARY.FOREGROUND,";box-shadow:",g.shadows.MEDIUM,";}"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0)))),ShowMore_G=/* @__PURE__ */(/* unused pure expression or super */ null && (b("div", true?{target:"ex8l8uj1"}:0)(_ref2=>{let{theme:g}=_ref2;return/*#__PURE__*//* @__PURE__ */A("-webkit-box-flex:1;flex-grow:1;height:1px;background-color:",g.colors.PRIMARY.ACCENT_2,";"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0))));var ShowMore_B= true?{name:"21xn5r",styles:"transform:rotate(180deg)"}:0;const ShowMore_i=/* @__PURE__ */(/* unused pure expression or super */ null && (b("svg", true?{target:"ex8l8uj0"}:0)("margin-left:6px;transition:transform 0.2s ease-in-out;",_ref3=>{let{expanded:g}=_ref3;return g&&ShowMore_B;},";"+( true?"":0))));
;// ../../packages/design-system/dist/components/Snippet/index.js
const Snippet_excluded=(/* unused pure expression or super */ null && (["width","text","handleCopy","fill"]));function Snippet_X(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Snippet_o=g=>{const _U=U(g),{width:G="300px",text:b,handleCopy:l,fill:c}=_U,Z=_objectWithoutPropertiesLoose(_U,Snippet_excluded),V=d(null);return/* @__PURE__ */J(Snippet_x,Object.assign({width:G,fill:String(c)},Z,{ref:V,children:[b.map((C,y)=>/* @__PURE__ */A(R,Object.assign({},Z,{children:C}),C+"-"+y)),/* @__PURE__ */A(Snippet_N,{onClick:()=>{var _ref;var C;return l((_ref=(C=V.current)==null?void 0:C.innerText)!==null&&_ref!==void 0?_ref:"");},children:/* @__PURE__ */A("svg",{viewBox:"0 0 24 24",width:"24",height:"24",color:"currentcolor",stroke:"currentcolor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",fill:"none",shapeRendering:"geometricPrecision",children:/* @__PURE__ */A("path",{d:"M8 17.929H6c-1.105 0-2-.912-2-2.036V5.036C4 3.91 4.895 3 6 3h8c1.105 0 2 .911 2 2.036v1.866m-6 .17h8c1.105 0 2 .91 2 2.035v10.857C20 21.09 19.105 22 18 22h-8c-1.105 0-2-.911-2-2.036V9.107c0-1.124.895-2.036 2-2.036z"})})})]}));},Snippet_B=_ref2=>{let{fill:g}=_ref2;return{primary:{background:I.PRIMARY.BACKGROUND,border:I.PRIMARY.ACCENT_2,color:I.PRIMARY.FOREGROUND},secondary:{background:g?I.PRIMARY.ACCENT_5:I.PRIMARY.BACKGROUND,border:I.PRIMARY.ACCENT_5,color:g?I.PRIMARY.BACKGROUND:I.PRIMARY.ACCENT_5},success:{background:g?I.SUCCESS.DEFAULT:I.PRIMARY.BACKGROUND,border:I.SUCCESS.DEFAULT,color:g?I.PRIMARY.BACKGROUND:I.SUCCESS.DEFAULT},error:{background:g?I.ERROR.DEFAULT:I.PRIMARY.BACKGROUND,border:I.ERROR.DEFAULT,color:g?I.PRIMARY.BACKGROUND:I.ERROR.DEFAULT},warning:{background:g?I.WARNING.DEFAULT:I.PRIMARY.BACKGROUND,border:I.WARNING.DEFAULT,color:g?I.PRIMARY.BACKGROUND:I.WARNING.DEFAULT},lite:{background:I.PRIMARY.ACCENT_1,border:I.PRIMARY.ACCENT_2,color:I.PRIMARY.FOREGROUND}};},Snippet_x=/* @__PURE__ */(/* unused pure expression or super */ null && (u("div", true?{target:"e1vmhrqh2"}:0)(_ref3=>{let{theme:g,width:G,type:b,dark:l,fill:c}=_ref3;return/*#__PURE__*//* @__PURE__ */i("position:relative;width:",G,";max-width:100%;padding:9px 42px 9px 12px;box-sizing:border-box;border-radius:5px;background:",Snippet_B({fill:c==="true"})[b].background,";border:1px solid ",Snippet_B({fill:c==="true"})[b].border,";color:",Snippet_B({fill:c==="true"})[b].color,";",l&&/*#__PURE__*//* @__PURE__ */i("background:",g.colors.PRIMARY.FOREGROUND,";border:1px solid ",g.colors.PRIMARY.FOREGROUND,";color:",g.colors.PRIMARY.BACKGROUND,";"+( true?"":0), true?"":0, true?"":0, true?"":0),";"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0))));var Snippet_m= true?{name:"1yk183z",styles:"&:before{content:'$ ';user-select:none;}"}:0;const R=/* @__PURE__ */(/* unused pure expression or super */ null && (u("pre", true?{target:"e1vmhrqh1"}:0)("text-align:left;margin:0;font-size:13px;line-height:20px;color:currentcolor;",_ref4=>{let{prompt:g}=_ref4;return g&&Snippet_m;},";"+( true?"":0)))),Snippet_N=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("button", true?{target:"e1vmhrqh0"}:0)( true?{name:"1i7g3zn",styles:"color:currentcolor;outline:none;cursor:pointer;position:absolute;top:3px;right:0;display:flex;align-items:center;background:none;border:none;outline:none;padding:4px 12px;border-radius:0 5px 5px 0;transition:opacity 0.15s ease;&:hover{opacity:0.5;}"}:0);
...
const Progress_J=I=>{const _l=l(I),g=Object.assign({},(_objectDestructuringEmpty(_l),_l));return/* @__PURE__ */A(Progress_X,Object.assign({},g));},Progress_C={primary:{background:type/* Colors */.Jy.PRIMARY.FOREGROUND},secondary:{background:type/* Colors */.Jy.PRIMARY.ACCENT_5},success:{background:type/* Colors */.Jy.SUCCESS.DEFAULT},error:{background:type/* Colors */.Jy.ERROR.DEFAULT},warning:{background:type/* Colors */.Jy.WARNING.DEFAULT}},Progress_X=/* @__PURE__ */(/* unused pure expression or super */ null && (G("progress", true?{target:"e9um2al0"}:0)("appearance:none;border:none;width:100%;height:10px;display:block;vertical-align:unset;",_ref=>{let{type:I}=_ref;return/*#__PURE__*//* @__PURE__ */b("&[value]::-webkit-progress-value{background:",Progress_C[I].background,";}&[value]::-moz-progress-bar{background:",Progress_C[I].background,";}"+( true?"":0), true?"":0, true?"":0, true?"":0);}," ",_ref2=>{let{theme:I,nowColor:g}=_ref2;return/*#__PURE__*//* @__PURE__ */b("&[value]::-webkit-progress-bar{background:",I.colors.PRIMARY.ACCENT_2,";border-radius:5px;}@-moz-document url-prefix(){border-radius:5px;background:",I.colors.PRIMARY.ACCENT_2,";}&[value]::-webkit-progress-value{",g&&/*#__PURE__*//* @__PURE__ */b("background:",g,";"+( true?"":0), true?"":0, true?"":0, true?"":0),";border-radius:5px;transition:width 0.15s ease;}&[value]::-moz-progress-bar{",g&&/*#__PURE__*//* @__PURE__ */b("background:",g,";"+( true?"":0), true?"":0, true?"":0, true?"":0),";border-radius:5px;transition:width 0.15s ease;}"+( true?"":0), true?"":0, true?"":0, true?"":0);},";"+( true?"":0))));
;// ../../packages/design-system/dist/components/LoadingDots/index.js
var _templateObject;function LoadingDots_g(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const LoadingDots_n=b=>{const{size:u,children:l}=a(b);return/* @__PURE__ */W(LoadingDots_t,{style:{"--loading-dots-size":u+"px"},children:[l&&/* @__PURE__ */c(LoadingDots_R,{children:l}),/* @__PURE__ */c(LoadingDots_I,{}),/* @__PURE__ */c(LoadingDots_I,{}),/* @__PURE__ */c(LoadingDots_I,{})]});},LoadingDots_t=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("span", true?{target:"e1i4awf02"}:0)( true?{name:"d8ykiv",styles:"display:inline-flex;align-items:center;height:auto"}:0),LoadingDots_R=/* @__PURE__ */(0,emotion_styled_base_browser_esm/* default */.A)("div", true?{target:"e1i4awf01"}:0)( true?{name:"1j97xhc",styles:"margin-right:12px"}:0),LoadingDots_I=/* @__PURE__ */(/* unused pure expression or super */ null && (G("span", true?{target:"e1i4awf00"}:0)("width:var(--loading-dots-size);height:var(--loading-dots-size);border-radius:50%;",_ref=>{let{theme:b}=_ref;return/*#__PURE__*//* @__PURE__ */Z("animation:",LoadingDots_i(b)," 1.4s both infinite;background:",b.colors.PRIMARY.ACCENT_2,";"+( true?"":0), true?"":0, true?"":0, true?"":0);}," display:inline-block;margin:0 1px;&:nth-of-type(2){animation-delay:0.2s;}&:nth-of-type(3){animation-delay:0.4s;}"+( true?"":0)))),LoadingDots_i=b=>C(_templateObject||(_templateObject=_taggedTemplateLiteralLoose(["\n  0% {\n    background: ",";\n  }\n  \n  50% {\n    background: ",";\n  }\n\n  100% {\n    background: ",";\n  }\n"])),b.colors.PRIMARY.ACCENT_2,b.colors.PRIMARY.ACCENT_6,b.colors.PRIMARY.ACCENT_2);
;// ../../packages/design-system/dist/components/Note/index.js
function Note_l(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Note_U=g=>{const{label:c="Note",fill:G=!1,variant:V="standard",type:J="primary",action:b=null,size:B="medium",children:y}=g;return/* @__PURE__ */C(Note_N,{label:c,fill:String(G),variant:V,type:J,action:b,size:B,children:[/* @__PURE__ */C("span",{children:[!!c&&/* @__PURE__ */C("span",{children:[c,": "]}),y]}),/* @__PURE__ */u("div",{children:b&&b})]});},Note_A=_ref=>{let{fill:g,variant:c}=_ref;return{primary:{background:g?I.PRIMARY.FOREGROUND:I.PRIMARY.BACKGROUND,border:I.PRIMARY.ACCENT_2,color:g?I.PRIMARY.BACKGROUND:I.PRIMARY.FOREGROUND},secondary:{background:c==="contrast"?I.PRIMARY.ACCENT_2:g?I.PRIMARY.ACCENT_5:I.PRIMARY.BACKGROUND,border:I.PRIMARY.ACCENT_5,color:c==="contrast"?I.PRIMARY.ACCENT_7:g?I.PRIMARY.BACKGROUND:I.PRIMARY.ACCENT_5},success:{background:c==="contrast"?I.SUCCESS.LIGHTER:g?I.SUCCESS.DEFAULT:I.PRIMARY.BACKGROUND,border:I.SUCCESS.DEFAULT,color:c==="contrast"?I.SUCCESS.DARK:g?I.PRIMARY.BACKGROUND:I.SUCCESS.DEFAULT},error:{background:c==="contrast"?I.ERROR.LIGHTER:g?I.ERROR.DEFAULT:I.PRIMARY.BACKGROUND,border:I.ERROR.DEFAULT,color:c==="contrast"?I.ERROR.DARK:g?I.PRIMARY.BACKGROUND:I.ERROR.DEFAULT},warning:{background:c==="contrast"?I.WARNING.LIGHTER:g?I.WARNING.DEFAULT:I.PRIMARY.BACKGROUND,border:I.WARNING.DEFAULT,color:c==="contrast"?I.WARNING.DARK:g?I.PRIMARY.BACKGROUND:I.WARNING.DEFAULT}};};var Note_i= true?{name:"1yw0d4j",styles:"padding:11px 12px;min-height:48px;font-size:16px"}:0,Note_R= true?{name:"n6oh4",styles:"padding:7px 12px;min-height:40px"}:0,Note_d= true?{name:"9klv42",styles:"padding:3px 12px;min-height:32px"}:0;const Note_N=/* @__PURE__ */(/* unused pure expression or super */ null && (m("div", true?{target:"e1wsneen0"}:0)("display:flex;align-items:center;border-radius:5px;line-height:24px;font-size:0.875rem;word-break:break-word;box-sizing:border-box;",g=>/*#__PURE__*//* @__PURE__ */Z("color:",Note_A(Object.assign({},g,{fill:g.fill==="true"}))[g.type].color,";background:",Note_A(Object.assign({},g,{fill:g.fill==="true"}))[g.type].background,";border:1px solid ",Note_A(Object.assign({},g,{fill:g.fill==="true"}))[g.type].border,";",g.size==="small"&&Note_d," ",g.size==="medium"&&Note_R," ",g.size==="large"&&Note_i,";"+( true?"":0), true?"":0, true?"":0, true?"":0)," &>span{&>span{font-weight:600;}}&>div{margin-left:auto;padding-left:0.75rem;}"+( true?"":0))));
...
//# sourceMappingURL=app-685a40843825a30b9b95.js.map